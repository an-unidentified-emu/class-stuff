...
aStds = [
    data[(data['TypeofForce'] == 'B') & (data['Angle'] == ANGLE) & (data['Mass'] ==   556.4 ) & (data['Date'] == DATE)] ['Pull-Force'].std(),
    data[(data['TypeofForce'] == 'B') & (data['Angle'] == ANGLE) & (data['Mass'] ==   956.4 ) & (data['Date'] == DATE)] ['Pull-Force'].std(),
    data[(data['TypeofForce'] == 'B') & (data['Angle'] == ANGLE) & (data['Mass'] ==  5556.4 ) & (data['Date'] == DATE)] ['Pull-Force'].std(),
    data[(data['TypeofForce'] == 'B') & (data['Angle'] == ANGLE) & (data['Mass'] == 10556.4 ) & (data['Date'] == DATE)] ['Pull-Force'].std()
]
...
plt.errorbar(Gforce, fMeans, fStds, fmt='.', color='red', label='Static Force Data')
...
plt.errorbar(Gforce, aMeans, aStds, fmt='.', color='green', label='Kinetic Force Data')
...
plt.savefig("static-both.svg", format = 'svg')
#plt.show()